 ...
 */
window.Helper = (function(window, document, undefined ) {
  var Helper = {};
   ...
   */
  Helper.reflection = function (obj) {
 ...
 function getAllPropertyNames( obj ) {
   ...
   */
  Helper.properties = function (obj) {
   ...
   * @returns string
   */
  Helper.dumpAsString = function (obj) {
    var s = '\n';
    for (var prop in obj) {
      if (obj.hasOwnProperty(prop)) {
        s += prop + ' : ' + obj[prop] + '\n';
   ...
   */
  Helper.deleteLESSFromLocalStorage = function (which) {
